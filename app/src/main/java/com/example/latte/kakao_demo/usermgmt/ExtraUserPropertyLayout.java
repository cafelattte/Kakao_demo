package com.example.latte.kakao_demo.usermgmt;
...
import com.example.latte.kakao_demo.widget.KakaoDialogSpinner;
...
public class ExtraUserPropertyLayout extends FrameLayout {
    ...
    public ExtraUserPropertyLayout(Context context, AttributeSet attrs, int defStyleAttr) {
